...
| `Tested Students`     | Discrete           | number of students form a school that completed the MCAS assessment                                                                                                                 |
| `School Size`     | Ordinal           | classification of size of school based on number of students that completed the HS Physics MCAS exam                                                                                                                 |
| `Practice Category Pts`   | Discrete           | The number of points available for items in a given scientific practice category                                                                                                                       |
