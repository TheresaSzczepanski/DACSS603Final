...
-   A school's summary performance on items in a given content `Reporting Category` is positively associated with     the `Reporting Category's` weight within the exam.
:::
