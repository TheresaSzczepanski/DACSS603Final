...
```{r}
HSPhy_NextGen_SchoolIT301DF <- left_join(HSPhy_NextGen_SchoolItemDF, HSPhys_NextGenIT301, by = c("Year" = "Year", "Subject" = "Subject", "ITEM" = "ITEM"))
...
## Join State Achievement Report to SchooIT301 Reports
...
HSPhy_NextGen_PerfDF<- HSPhy_NextGen_StateAchievementDF%>%
  ...
  left_join(HSPhy_NextGen_SchoolIT301DF, by = c("Year" = "Year", "Subject" = "Subject", "School Code" = "School Code"))
